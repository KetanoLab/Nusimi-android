...
public class FavoritosDbAdapter {
	...
	public boolean eraseFavorite(long rowId) {
		return mDb.delete(DATABASE_TABLA, KEY_ID + "=" + rowId, null) > 0;
	}

	public boolean eraseFavorite(String palabra, String nombreArchivoDbDiccionario) {
	...
	public boolean isFavorite(String word, String dictionaryName) {
		String[] args = new String[] { word, dictionaryName };
